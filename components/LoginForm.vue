      ...
      <v-list class="text-center">
        <v-list-item-group>
          <v-list-item-content
            ...
            "
          >
            <v-text-field v-if="language === '한국어'" v-model="email" :rules="emailRules" label="이메일" type="email" clearable dense tabindex="1" />
            <v-text-field v-else-if="language === '영어'" v-model="email" :rules="e_emailRules" label="Email" type="email" clearable dense />
          </v-list-item-content>
          <v-list-item-content
            style="
               {
            ...
            "
          >
            <v-text-field v-if="language === '한국어'" v-model="password" :rules="passwordRules" label="비밀번호" type="password" clearable dense tabindex="2" />
            <v-text-field v-else-if="language === '영어'" v-model="password" :rules="e_passwordRules" label="Password" type="password" clearable dense />
          </v-list-item-content>
        </v-list-item-group>
        <v-list-item-action>
          <v-btn v-if="language === '한국어'" style="width: 100%" depressed :disabled="!valid" type="submit" @click="onEmit">로그인</v-btn>
