    ...
    <v-card v-else-if="sels === 1" outlined elevation="10">
      ...
      <v-container v-if="language === '한국어'">
        <v-form ref="form" v-model="valid" @submit.prevent>
                    ...
                    <div class="outer-pdf">
                        ...
                        <table class="tg" style="undefined;table-layout: fixed; width: 550px">
                          ...
                          <thead>
                            <tr>
                              ...
                              <td class="tg-jbyd">대표</td>
                              <td class="tg-jbyd">김 운</td>
                            </tr>
                            <tr>
                              <td class="tg-jbyd">회사</td>
                              <td class="tg-jbyd">DMTLABS</td>
                            </tr>
                            <tr>
                              <td class="tg-jbyd">주소</td>
                              <td class="tg-jbyd">
                                <span
                            ...
                            <tr>
                              <td class="tg-jbyd">연락처</td>
                              <td class="tg-jbyd">02-794-5333</td>
                            </tr>
                          </thead>
                        </table>
                      </section>
                        ...
                        <table class="tg" style="undefined;table-layout: fixed; width: 550px">
                          ...
                          <thead>
                            <tr>
                              ...
                              <td class="tg-jbyd">성 함</td>
                              <td class="tg-jbyd">{{name}}</td>
                            </tr>
                            <tr>
                              <td class="tg-jbyd">회사</td>
                              <td class="tg-jbyd">{{company}}</td>
                            </tr>
                            <tr>
                              <td class="tg-jbyd">연락처</td>
                              <td class="tg-jbyd">
                            ...
                            <tr>
                              <td class="tg-jbyd">요청 날짜</td>
                              <td class="tg-jbyd">{{date}}</td>
                            </tr>
                          </thead>
                        </table>
                      </section>
                      ...
                      <section class="pdf-table">
                        <table class="tg" style="undefined;table-layout: fixed; width: 545px">
                          ...
                          <thead>
                            <tr>
                              <th class="tg-6qw1">번역 정보</th>
                              <th class="tg-6qw1">가격</th>
                              <th class="tg-6qw1">기타</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td
                                class="tg-baqh"
                              >{{e_languages[this.languages.indexOf(this.req_lang[0])]}} -&gt; {{e_languages[this.languages.indexOf(this.grant_lang[0])]}}</td>
                              <td class="tg-baqh">{{price[0]}} 원</td>
                              <td class="tg-baqh"></td>
                            </tr>
                            <tr>
                              <td
                                class="tg-baqh"
                              >{{e_languages[this.languages.indexOf(this.req_lang[1])]}} -&gt; {{e_languages[this.languages.indexOf(this.grant_lang[1])]}}</td>
                              <td class="tg-baqh">{{price[1]}} 원</td>
                              <td class="tg-baqh"></td>
                            </tr>
                            <tr>
                              <td
                                class="tg-baqh"
                              >{{e_languages[this.languages.indexOf(this.req_lang[2])]}} -&gt; {{e_languages[this.languages.indexOf(this.grant_lang[2])]}}</td>
                              <td class="tg-baqh">{{price[2]}} 원</td>
                              <td class="tg-baqh"></td>
                            </tr>
                            <tr>
                              <td
                                class="tg-baqh"
                              >{{e_languages[this.languages.indexOf(this.req_lang[3])]}} -&gt; {{e_languages[this.languages.indexOf(this.grant_lang[3])]}}</td>
                              <td class="tg-baqh">{{price[3]}} 원</td>
                              <td class="tg-baqh"></td>
                            </tr>
                            <tr>
                              <td
                                class="tg-baqh"
                              >{{e_languages[this.languages.indexOf(this.req_lang[4])]}} -&gt; {{e_languages[this.languages.indexOf(this.grant_lang[4])]}}</td>
                              <td class="tg-baqh">{{price[4]}} 원</td>
                              <td class="tg-baqh"></td>
                            </tr>
                            <tr>
                              <td class="tg-nro3">총 합계</td>
                              <td
                                class="tg-nro3"
                                colspan="2"
          ...
          <div class="request__btn">
            ...
            <v-btn v-if ="checkSendFile" depressed color="#0d6efd" dark large style="margin: 10px" @click="generatePdf()">
              견적서 발급
      ...
      <v-container v-else-if="language === '영어'">
        <v-form ref="form" v-model="valid" @submit.prevent>
          ...
          <div class="request__btn">
            <v-spacer class="spacer" />
            <v-btn depressed color="#0d6efd" dark large style="margin: 10px" @click="generatePdf()">
              Issuing Quotation
              <v-icon right>mdi-file-download</v-icon>
            </v-btn>
            <v-btn
