<template>
    <div class="wrapper">
            ...
            <div class="video__list">
                <v-expansion-panels class="video__list__group" tile dark>
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content v-else class="video__list__content overflow-y-auto">
        ...
        <div ref="trackBox" class="track__box">
            <v-virtual-scroll ref="trackscroll" v-if="readyToTrack" class="track__box__scroll" bench="15" :items="fullTrack" :height="virtualHeight" item-height="156">
